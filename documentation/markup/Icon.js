export const Stylesheet = ({ size = 100 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
...
export const ScaledValues = ({ size = 100 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
...
export const AdaptiveValues = ({ size = 100 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
  ...
  >
    ...
    <line
      ...
      strokeLinecap="round"
    />
    <circle cx="70" cy="50" r="12.5" stroke="white" strokeWidth="5" />
  </svg>
)

export const Breakpoints = ({ size = 100 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
